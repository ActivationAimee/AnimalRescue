...
<html>
	...
	<body>
        ...
        <form method="post" action="/saveTheAnimal/protectWrite.anires?page=1">
		<table class="type01">
        	<tr>
            	<td class="style1">保護キャンペン名</td>
        ...
        <div>             
               	...
               	<button type="submit" class="btn_ok" onclick="alert('情報が登録しました。')">作成</button>
        </div>    
        </form>
		</div>
