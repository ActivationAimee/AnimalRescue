	...
	<body>
		...
		<c:if test = "${member.admin==1 }">
			<form method="post" action = "protectDelete.anires?num=${ptList.protectnum}">
				<button type="submit" class="btn_ok" onclick = "showConfirm();" >削除</button>
			</form>
				<button class="btn_ok" onclick = "location.href = 'protectModify.anires?num=${ptList.protectnum}'">修正</button>
		</c:if>		
				<button class="btn_ok" onclick = "location.href = 'protectList.anires?page=1'">戻る</button>
		</div>
