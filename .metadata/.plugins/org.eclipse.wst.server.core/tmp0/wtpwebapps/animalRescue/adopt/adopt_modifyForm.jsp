...
<script type="text/javascript">
	function checkForm() {
		...
		if (chk1.test(date) == false || chk2.test(date) == false) { 
			alert("2019-01-01の形式や2019-1-1ような形式に入力してください");
		    aw.ani_date.value = "";
		    aw.ani_date.focus();
		    return false;
		}
	    // 날짜 유효성 검사
	    var strValue = aw.ani_date.value;
...
<body>
	...
	<div align="center">
		<h3>保護者募集の修正</h3>
		<form action="adopt_modify.anires" name="aw" method="post" onsubmit="return checkForm()">
			<table class="type01">
				<tr>
					<td colspan="2">
						<c:if test="${img == null}">
					...
					<input type="hidden" name="ani_no" value="${aa.ani_no}">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="style2">
						<input type="text" name="ani_subject"style="width:170px; height:36px; border:none" maxlength="20" value="${aa.ani_subject}"></td>
				</tr>
				<tr>
					<td class="style1">お名前</td>
					<td class="style2">
						<input type="text" name="ani_name"  style="width:170px; height:36px; border:none" value="${aa.ani_name}">
					</td>
				</tr>
				<tr>
					<td class="style1">携帯番号</td>
					<td class="style2">
						<input type="text" name="ani_tel" maxlength="13" style="width:170px; height:36px; border:none" value="${aa.ani_tel}">
					</td>
				</tr>
				<tr>
					<td class="style1">パスワード</td>
					<td class="style2">
						<input type="text" name="ani_pass" style="width:170px; height:36px; border:none" value="${aa.ani_pass}">
					</td>
				</tr>
				<tr>
					...
					<td class="style2">
						<input type="text" name="ani_date"  maxlength="10" style="width:170px; height:36px; border:none" value="${aa.ani_date}">
					</td>
				</tr>
				<tr>
					...
					<td colspan="2" class="style2">
						<textarea rows="10" cols="65" name="ani_content" style="width:520px; height:150px; border:none">${aa.ani_content}</textarea>
					</td>
				</tr>
			</table>
			<table>
        		<tr height="30">
         	       ...
         	       <td width = "80" align="right">
         		       	<input type="button" value="取り消し"onclick="self.close()" class="btn_ok">
        	        </td>
         	   </tr>
       		</table>
		</form>
