...
<html>
	...
	<body>
		...
		<form name = "animalS" method = "post" action="/animalRescue/searchSearch.anires">
			...
			<div id="ContentArea" >
				<c:choose>
					...
					<c:otherwise>
						<div><h1>全体リスト</h1>※灰色の項目は帰宅済みです。</div>
					</c:otherwise>
				</c:choose>
					...
					<div class="searchListcon" style = "border:2px solid green; border-radius:10px;">
						...
						<input type="submit" value = "検索" class="btn_ok"/><br><br>
					</div>
					</c:if>
		...
		<c:if test = "${member!=null }">
			<p align="right">
				<button class = "btn_ok" onclick = "location.href='/animalRescue/search/searchWrite.jsp'">登録</button>
			</p>
		</c:if>
