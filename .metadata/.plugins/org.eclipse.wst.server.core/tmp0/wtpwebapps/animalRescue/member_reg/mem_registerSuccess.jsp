	...
	<body>
		...
		<div class="header">
			...
			<div class="formsucbox">
				<h2 class="lo">個人会員登録完了</h2><br>
				<h4 class="lo">${id}様、WELCOME!</h4><br><br>
				<br><br>
				
							
				<div class="lo">
					<a href="/animalRescue/member_login/mem_loginForm.jsp"><input type="submit" value="ログインページへ" class="btn_logok"/></a>
				</div>	
</div>
</div>
