...
<html>
	...
	<body>
		...
		<form name = "supportW" method = "post" action = "/animalRescue/supportModifySuccess.anires" enctype="Multipart/form-data" onsubmit="return check_form()">
			<input type = "hidden" name = "snum" value = "${sp.snum }"/>
	        ...
	        <table>
	        	<tr height="30">
					<td width = "650" align="right">
						<input type="submit" id="listbutton" value = "登録"/>
	                </td>
