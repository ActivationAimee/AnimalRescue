	...
	<body>
			...
			<table class="type01">
	                ...
	                <td class="style2">
	                		<select name = "ani_kind">
								<option value = "${as.ani_kind }">
									<c:if test="${as.ani_kind =='kind_dog'}">
										犬
									</c:if>
				...
				<tr>
					...
					<td class = "style1">状況</td>
					<td class="style2">
						<input type="radio" name="ani_now" value = 0 checked="checked">未捜索</input>&nbsp;&nbsp;&nbsp;
						<input type="radio" name="ani_now" value = 1>捜索済み</input>
					</td>
				</tr>
			</table>
					<td width = "650" align="right">
						<input type="submit" class = "btn_ok" value = "修正"/>
	                </td>
