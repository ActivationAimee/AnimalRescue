	...
	<body>
		...
		<c:if test = "${member.admin==1 }">
			<form method="post" action = "delete.anires?num=${hpList.hospitalnum}">
				...
				<button class="btn_ok" onclick = "location.href = 'modify.anires?num=${hpList.hospitalnum}'">修正</button>
		</c:if>
				<button class="btn_ok" onclick = "location.href = 'list.anires?page=1'">戻る</button>
		</div>
