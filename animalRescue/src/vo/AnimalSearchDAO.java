...
public class AnimalSearchDAO {
	...
	public ArrayList<AnimalSearch> selectPeriArea(Date sdate, Date edate, String area,int attribute,int now) {
		AnimalSearch as = null;
		ArrayList<AnimalSearch> list = new ArrayList<AnimalSearch>();
		
		String sql = "select * from animal_search where ani_date between ? and ? and ani_area = ? and ani_attribute = ? and ani_now=?";
	...
	public ArrayList<AnimalSearch> selectPeriKind(Date sdate, Date edate, String kind,int attribute,int now) {
		AnimalSearch as = null;
		ArrayList<AnimalSearch> list = new ArrayList<AnimalSearch>();
		
		String sql = "select * from animal_search where ani_date between ? and ? and ani_kind = ? and ani_attribute = ? and ani_now=?";
	...
	public ArrayList<AnimalSearch> selectAreaKind(String area,String kind,int attribute,int now) {
		AnimalSearch as = null;
		ArrayList<AnimalSearch> list = new ArrayList<AnimalSearch>();
		
		String sql = "select * from animal_search where ani_area = ? and ani_kind = ? and ani_attribute = ? and ani_now=?";
	...
	public ArrayList<AnimalSearch> selectAll(Date sdate, Date edate, String area, String kind,int attribute,int now) {
		AnimalSearch as = null;
		ArrayList<AnimalSearch> list = new ArrayList<AnimalSearch>();
		
		String sql = "select * from animal_search where ani_date between ? and ? "
				+ "and ani_area = ? and ani_kind = ? and ani_attribute = ? and ani_now=?";
